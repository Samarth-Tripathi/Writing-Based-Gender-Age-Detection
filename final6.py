...
model5.add(Dropout(dropout))
'''
model1.load_weights('5.h5', by_name=True)
model3.load_weights('5.h5', by_name=True)
model5.load_weights('5.h5', by_name=True)
#model5.load_weights('4.h5', by_name=True)
...
intermediate_layer_model = Model(inputs=model4.input,
                                 outputs=model4.get_layer("my_dense_4").output)
...
modelnn.add(Activation('relu'))
modelnn.add(Dropout(dropout))
modelnn.load_weights('5.h5', by_name=True)
